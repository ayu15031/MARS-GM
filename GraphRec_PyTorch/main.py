...
parser.add_argument('--dataset', default='FilmTrust', help='dataset directory path: datasets/Ciao/Epinions')
...
def main():
    ...
    for epoch in tqdm(range(args.epoch)):
        ...
        loss = trainForEpoch(train_loader, model, optimizer, epoch, args.epoch, criterion, log_aggr = 100)
        losses.append(loss)
